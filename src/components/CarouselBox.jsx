    ...
    return (
        <>
            <Box height={'100%'} width={'90%'} bg={'#e2f2ff'} margin={'auto'} display={'flex'} flexDirection={['column-reverse','row','row','row']} alignItems={'center'} justifyContent={['space-around']} pb={['10','2','1','0']} >
                ...
                <Stack gap={['2','2','2','3']} bg={'white'} color={'black'} boxShadow={'0px 4px 35px #85858580'} width={['90%', '40%', '40%', '40%']} top={'23%'} left={'12'} textAlign={'left'} p={['6','6','6','8']}>
                    <Heading color={'blackAlpha.900'} fontFamily={"Young Serif"} fontSize={['xl','2xl','2xl','3xl']}>{title}</Heading>
                ...
                <Box textAlign={'right'} width={['90%','40%','40%','40%']} >
